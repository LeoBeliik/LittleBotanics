...
public class LittleManaBargeItem extends Item {
    ...
    public LittleManaBargeItem(Properties p_i48526_2_, Function4<Level, Double, Double, Double, Entity> addEntity, String tooltip) {
        super(p_i48526_2_);
        this.addEntity = addEntity;
        this.tooltipLocation = Optional.of(tooltip);
    }

    public LittleManaBargeItem(Properties p_i48526_2_, Function4<Level, Double, Double, Double, Entity> addEntity) {
        super(p_i48526_2_);
        this.addEntity = addEntity;
    }
    ...
    private Entity getEntity(Level world, BlockHitResult raytraceresult) {
