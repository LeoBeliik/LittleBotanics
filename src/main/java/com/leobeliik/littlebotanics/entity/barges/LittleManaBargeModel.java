...
public class LittleManaBargeModel extends EntityModel<LittleManaBargeEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("pool", CubeListBuilder.create()
                        ...
                        .texOffs(24, 16).addBox(-6.0F, -8.0F, -6.0F, 12.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)), //b
                PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition barge = partdefinition.addOrReplaceChild("barge", CubeListBuilder.create() //TODO
